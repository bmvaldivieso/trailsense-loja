...
class DetalleSenderoScreen extends GetView<DetalleSenderoController> {
  ...
  void _volverASenderos() {
    Get.find<MainController>().changePage(1); // Pestaña Senderos
    Get.back();
  }
                ...
                children: [
                  TileLayer(
                    ...
                    userAgentPackageName:
                        'com.trailsenseloja.trailsense_mobile',
                  ),
                  PolylineLayer(
                    polylines: [
                      Polyline(
                        points: sendero.puntos,
                        strokeWidth: 4.0,
                    ...
                    children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                _MetricItem(
                                  ...
                                  text: 'Estado: ${sendero.estado}',
                                  iconColor: const Color(0xFF3B82F6),
                                ),
                                SizedBox(height: 8.h),
                                _MetricItem(
                                  icon: Icons.location_on_outlined,
                                  text: '${sendero.longitudKm} km de recorrido',
                                ...
                                if (sendero.horarioApertura != null) ...[
                                  ...
                                  _MetricItem(
                                    ...
                                    text:
                                        '${sendero.horarioApertura} - ${sendero.horarioCierre}',
                                    iconColor: Colors.redAccent,
                                  ),
                                ],
                                SizedBox(height: 8.h),
                                _MetricItem(
                                  icon: Icons.terrain,
                                  text: 'Dificultad: ${sendero.dificultad}',
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 12.sp,
                          color: const Color(0xFF474B66),
                        ),
                      ),
                      SizedBox(height: 4.h),
                      Text(
                        sendero.descripcion.isNotEmpty
                            ? sendero.descripcion
